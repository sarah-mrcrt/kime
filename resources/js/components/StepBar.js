            ...
            {props.steps.map((step,index) => {
                ...
                return (
                    <div className={"step-bar__step " + checkedClass} key={index}>
                        {index+1 <= nb ? (
                            <svg id={"step" + index} className="step-bar__step__svg  svg__blue-check" enableBackground="new 0 0 32 32" version="1.1" viewBox="0 0 32 32" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg id={"step" + index} className="step-bar__step__svg svg__yellow-stroke-circle" enableBackground="new 0 0 32 32" version="1.1" viewBox="0 0 32 32" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
